...
## How to use:
  astronomy-calendar-core consists of three main components:
  ...
  - A displayable website GUI contained in the ./site folder that contains a viewable website form of the calendar
  Only python and a displayable site is required to make the core run (as you can see in test-exec.bat).
